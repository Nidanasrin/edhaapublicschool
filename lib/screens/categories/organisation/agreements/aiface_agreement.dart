...
class AifaceAgreement extends StatefulWidget {
  const AifaceAgreement({super.key});

  @override
  State<AifaceAgreement> createState() => _AifaceAgreementState();
}

class _AifaceAgreementState extends State<AifaceAgreement> {
  @override
