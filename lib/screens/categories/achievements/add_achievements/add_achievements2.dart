...
class AddAchievements2 extends StatefulWidget {
  final String selectedStudent;
  final String selectedClass;

  const AddAchievements2({super.key, required this.selectedStudent, required this.selectedClass});

  @override
  State<AddAchievements2> createState() => _AddAchievements2State();
}

class _AddAchievements2State extends State<AddAchievements2> {
  ...
  void saveRemark() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text("Achievements added successfully")),
    );
        ...
        body: Padding(
            ...
            child: Column(
                children: [
                  ...
                  SizedBox(height: 10,),
                  buildLabelAndField("Title", titleController, "Title",),
                  SizedBox(height: 10,),
                  buildLabelAndField("Description", descriptionController, "Description",maxLines: 3),
                  SizedBox(height: 10,),
                  Row(
                    children: [
                      const Expanded(
