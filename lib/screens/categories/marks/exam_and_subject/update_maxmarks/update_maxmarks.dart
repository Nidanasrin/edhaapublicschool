...
class UpdateMaxmarks extends StatefulWidget {
  const UpdateMaxmarks({super.key});

  @override
  State<UpdateMaxmarks> createState() => _UpdateMaxmarksState();
}

class _UpdateMaxmarksState extends State<UpdateMaxmarks> {
  ...
  void msgBox(){
    showDialog(context: context, builder: (context)=>
        AlertDialog(
          ...
          title: Text("Message"),
          content: Text("Marks not yet updated for these Exam"),
          actions: [
