...
final String selectedClass;
  ...
  const AddReview({super.key, required this.selectedStudent, required this.selectedClass});
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        buildLabelValueRow("Student Name", widget.selectedStudent),
            ...
            SizedBox(height: 10,),
             buildLabelAndField("Add Review", addReviewController, "Review",maxLines: 3),
            SizedBox(height: 10,),
