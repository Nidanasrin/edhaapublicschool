  ...
  void msgBox(){
    showDialog(context: context, builder: (context)=>
        AlertDialog(
          ...
          content: Text("Please fill all required fields.",style: TextStyle(fontSize: 16),),
          actions: [
  ...
  void msgBox2(){
    showDialog(context: context, builder: (context)=>
        AlertDialog(
          ...
          backgroundColor: Colors.white,
          title: Text("Message",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),),
          content: Text("No Attendance Details Available.",style: TextStyle(fontSize: 16),),
          actions: [
            TextButton(onPressed: (){
              Navigator.pop(context);
            }, child: Text("OK",style: TextStyle(color: Colors.indigo.shade900),))
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.start,
          children: [
                ...
                children: [
                  ...
                  Expanded(flex: 5,
                    child: DropdownButtonFormField<String>(
                        value: userType,isExpanded: true,
                  ...
                  children: [
                    ...
                    Expanded(flex: 5,
                      child: DropdownButtonFormField<String>(
                          ...
                          items: classStudents[selectedClass]!.map((String value) {
                            return DropdownMenuItem<String>(
                                value: value,
                                child: Text(
                                  value, style: TextStyle(color: Colors.black),)
            ...
            Row(
                children: [
                  Expanded(flex: 4,
                      child: Text("From Date             :", style: TextStyle(color: Colors.white,fontSize: 18))),
                  Expanded(flex: 5,
                    child: TextField(
                      onTap: (){
                        pickFromDate();
            ...
            Row(
                children: [
                  Expanded(flex: 4,
                      child: Text("To Date                  :", style: TextStyle(color: Colors.white,fontSize: 18))),
                  Expanded(flex: 5,
                    child: TextField(
                      onTap: (){
                        pickToDate();
                ...
                child: Column(
                    children: [
                      ElevatedButton(
                          ...
                          onPressed: (){
                            if(fromDateController.text.isNotEmpty && toDateController.text.isNotEmpty && userType!=null){
                              msgBox2();
