...
class CreateStudentwise extends StatefulWidget {
  const CreateStudentwise({super.key});

  @override
  State<CreateStudentwise> createState() => _CreateStudentwiseState();
}

class _CreateStudentwiseState extends State<CreateStudentwise> {
  String? selectedYear;
                ...
                onPressed: () {
                  ...
                  if(selectedValue == null || selectedValue!.isEmpty){
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                CreateStudentwiseDetails(selectedClass: selectedValue!,)));
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                        content: Text("Fees Allotment Successfully")));
