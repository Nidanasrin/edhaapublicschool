...
class CreateStudentwiseDetails extends StatefulWidget {

final String selectedClass;
  const CreateStudentwiseDetails({super.key, required this.selectedClass});
  @override
  State<CreateStudentwiseDetails> createState() => _CreateStudentwiseDetailsState();
}

class _CreateStudentwiseDetailsState extends State<CreateStudentwiseDetails> {
    ...
    return Scaffold(
      ...
      SingleChildScrollView(
        padding: EdgeInsets.only(left: 8.0),
                child: Text("Student Name",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 17),),
              ),
              Divider(thickness: 2,),
              Expanded(
                child:
                ListView.separated(itemBuilder: (context,index){
                  return ListTile(
                    ...
                    Icon(Icons.check_box,color: Colors.green,) : Icon(Icons.check_box_outline_blank,color: Colors.white,)),
                    title: Text(
                      students[index],
                      style: TextStyle(color: Colors.white),
                    ),);
