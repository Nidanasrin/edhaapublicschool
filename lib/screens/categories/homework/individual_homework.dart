...
class IndividualHomework extends StatefulWidget {
  const IndividualHomework({super.key});

  @override
  State<IndividualHomework> createState() => _IndividualHomeworkState();
}

class _IndividualHomeworkState extends State<IndividualHomework> {
            ...
            content: SizedBox(
              ...
              child: Signature(
                ...
                backgroundColor: Colors.grey
                    .shade200, // Light gray to see strokes
              ),
            ),
            actions: [
              Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                          flex: 4,
                          child: Text("Home Work", style: TextStyle(
                          ...
                          child: Container(
                            ...
                            child: _signatureImage == null
                              ...
                              child: Text(
                                ...
                                : Image.memory(
                                _signatureImage!, fit: BoxFit.contain),
                          ),
                        ),
                      ),
                    ],
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (selectedImage == null ||
                            ...
                            selectedClass!.isEmpty || selectedSubject == null ||
