...
class TiesPremium extends StatefulWidget {
  const TiesPremium({super.key});

  @override
  State<TiesPremium> createState() => _TiesPremiumState();
}

class _TiesPremiumState extends State<TiesPremium> {
        ...
        children: [
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemCount: tiesPremium.length,
              itemBuilder: (context, index) {
                final item = tiesPremium[index];
                return Padding(
