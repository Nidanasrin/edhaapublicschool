...
class TiesRegular extends StatefulWidget {
  const TiesRegular({super.key});

  @override
  State<TiesRegular> createState() => _TiesRegularState();
}

class _TiesRegularState extends State<TiesRegular> {
        ...
        children: [
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemCount: tiesRegular.length,
              itemBuilder: (context, index) {
                final item = tiesRegular[index];
                return Padding(
