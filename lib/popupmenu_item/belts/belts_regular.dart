...
class BeltsRegular extends StatefulWidget {
  const BeltsRegular({super.key});

  @override
  State<BeltsRegular> createState() => _BeltsRegularState();
}

class _BeltsRegularState extends State<BeltsRegular> {
        ...
        children: [
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemCount: beltsRegular.length,
              itemBuilder: (context, index) {
                final item = beltsRegular[index];
                return Padding(
